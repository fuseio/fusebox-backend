...
| configMap.wfuse_contract_address_mainnet | string | `""` | WFUSE contract address - Mainnet |
| configMap.wfuse_contract_address_testnet | string | `""` | WFUSE contract address - Testnet |
